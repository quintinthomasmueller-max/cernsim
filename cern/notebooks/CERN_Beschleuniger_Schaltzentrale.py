...
<script>(() => {
  ...
  async function orbitRing(dot, ring2, entryA, exitA, orbits, dur) {
    ...
    return new Promise((res) => {
      ...
      function step(ts) {
        ...
        dot.setAttribute(&quot;cx&quot;, ring2.cx + ring2.r * Math.cos(a));
        dot.setAttribute(&quot;cy&quot;, ring2.cy + ring2.r * Math.sin(a));
        p < 1 ? requestAnimationFrame(step) : res();
      }
      requestAnimationFrame(step);
    });
  ...
  function ring(g2, cx, cy, r, col, w) {
    g2.appendChild(mk(&quot;circle&quot;, { cx, cy, r, fill: &quot;none&quot;, stroke: col, &quot;stroke-width&quot;: w || 1.5 }));
  }
  function seg(g2, x1, y1, x2, y2, col, w, dash) {
    const a = { d: `M ${x1},${y1} L ${x2},${y2}`, fill: &quot;none&quot;, stroke: col, &quot;stroke-width&quot;: w || 1.5 };
    if (dash) a[&quot;stroke-dasharray&quot;] = dash;
    g2.appendChild(mk(&quot;path&quot;, a));
  }
  function drawInset(g2) {
    const BX = 8, BY = 56, BW = 166, BH = 150;
    const P = &quot;#58a6ff&quot;, I = &quot;#e377c2&quot;, PSc = &quot;#2ea44f&quot;, O = &quot;#ff7f0e&quot;;
    g2.appendChild(mk(&quot;rect&quot;, { x: BX, y: BY, width: BW, height: BH, rx: 6, fill: &quot;rgba(13,17,23,0.85)&quot;, stroke: &quot;rgba(139,148,158,0.5)&quot;, &quot;stroke-width&quot;: 1 }));
    g2.appendChild(label(BX + 8, BY + 14, &quot;INJEKTOR-KOMPLEX MEYRIN&quot;, { fill: &quot;#c9d1d9&quot;, &quot;font-size&quot;: &quot;7.5px&quot;, &quot;font-family&quot;: &quot;monospace&quot;, &quot;font-weight&quot;: &quot;bold&quot; }));
    g2.appendChild(label(BX + 8, BY + 24, &quot;Detail \xB7 schematisch (LINAC/LEIR \u2209 OSM)&quot;, { fill: &quot;rgba(139,148,158,0.9)&quot;, &quot;font-size&quot;: &quot;6px&quot;, &quot;font-family&quot;: &quot;monospace&quot; }));
    const psX = BX + 120, psY = BY + 92;
    ring(g2, psX, psY, 20, PSc, 2);
    const psbX = BX + 60, psbY = BY + 60;
    ring(g2, psbX, psbY, 8, P, 1.6);
    seg(g2, BX + 14, BY + 53, psbX - 7, psbY - 2, P, 1.6);
    seg(g2, psbX + 7, psbY + 4, psX - 16, psY - 12, P, 1.4);
    const leirX = BX + 60, leirY = BY + 120;
    ring(g2, leirX, leirY, 7, I, 1.6);
    seg(g2, BX + 14, BY + 130, leirX - 6, leirY + 2, I, 1.6);
    seg(g2, leirX + 6, leirY - 3, psX - 16, psY + 12, I, 1.4);
    const ex = BX + BW - 8;
    seg(g2, psX + 20, psY, ex, psY, O, 1.6, &quot;4,3&quot;);
    g2.appendChild(mk(&quot;path&quot;, { d: `M ${ex},${psY} l -6,-3 l 0,6 z`, fill: O }));
    const lab = (x, y, t, c, anc) => g2.appendChild(label(x, y, t, { fill: c, &quot;font-size&quot;: &quot;7px&quot;, &quot;font-family&quot;: &quot;monospace&quot;, &quot;text-anchor&quot;: anc || &quot;start&quot;, &quot;font-weight&quot;: &quot;bold&quot; }));
