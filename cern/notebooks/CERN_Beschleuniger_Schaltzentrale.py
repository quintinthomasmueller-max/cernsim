...
<div class=&quot;cv4-grid&quot;>
 <div class=&quot;cv4-svg-wrap&quot;>
  ...
  <button class=&quot;cv4-btn&quot; id=&quot;btn-zoom-meyrin&quot; style=&quot;position:absolute;bottom:12px;left:12px;padding:5px 10px;font-size:10px;background:rgba(22,27,34,0.88);border-color:#2ea44f;color:#8b949e;z-index:10;transition:all 0.2s;display:none&quot;>🔬 Injektor-Komplex (Meyrin)</button>
 ...
 <div class=&quot;cv4-panel&quot;>
  <div>
   ...
   <div style=&quot;display:grid;grid-template-columns:1fr 1fr 1fr;gap:6px;margin-bottom:8px&quot;>
    <div><button class=&quot;cv4-btn&quot; id=&quot;btn-pre-pp&quot; style=&quot;background:rgba(88,166,255,.10);border-color:#58a6ff;color:#58a6ff;font-size:9.5px;padding:6px 2px;width:100%&quot;>Protonen-Physik (13.6 TeV) <span class=&quot;cv4-pi-btn&quot; data-pi=&quot;prePp&quot;>ⓘ</span></button><div class=&quot;cv4-param-info&quot; id=&quot;pi-prePp&quot;></div></div>
    <div><button class=&quot;cv4-btn&quot; id=&quot;btn-pre-qgp&quot; style=&quot;background:rgba(227,119,194,.10);border-color:#e377c2;color:#e377c2;font-size:9.5px;padding:6px 2px;width:100%&quot;>Schwerionen / QGP (ALICE) <span class=&quot;cv4-pi-btn&quot; data-pi=&quot;preQgp&quot;>ⓘ</span></button><div class=&quot;cv4-param-info&quot; id=&quot;pi-preQgp&quot;></div></div>
    <div><button class=&quot;cv4-btn&quot; id=&quot;btn-pre-pilot&quot; style=&quot;background:rgba(23,190,207,.10);border-color:#17becf;color:#17becf;font-size:9.5px;padding:6px 2px;width:100%&quot;>Pilot / Inbetriebnahme <span class=&quot;cv4-pi-btn&quot; data-pi=&quot;prePilot&quot;>ⓘ</span></button><div class=&quot;cv4-param-info&quot; id=&quot;pi-prePilot&quot;></div></div>
   </div>
  </div>
...
<script>(() => {
  ...
  var DETSPEC = {
    ATLAS: {
      // Z⁰ = QGP-blinde „Standardkerze&quot; → in pp UND Pb-Pb messbar
      pool: () => CERN_REAL.pp,
      range: [50, 150],
      bins: 60,
      channel: &quot;2mu&quot;,
      ...
      reson: [{ key: &quot;Z0&quot;, m: 91.19, hw: 6, sg: 3, thr: 0.9, amp: 1, label: &quot;Z\u2070&quot; }],
      primary: &quot;Z0&quot;,
      title: &quot;ATLAS \xB7 Z\u2070\u2192\u03BC\u207A\u03BC\u207B \xB7 Pr\xE4zisions-Kalibrierkanal (echte CMS-Daten)&quot;,
      sub: &quot;Standardmodell-EW \xB7 Z\u2070-Resonanz bei 91 GeV (QGP-blinde Standardkerze)&quot;,
      disco: &quot;\u{1F31F} 5\u03C3: Z\u2070-Resonanz pr\xE4zise vermessen!&quot;
    },
    CMS: {
      // pp-Programm: Higgs-Goldkanal H→ZZ*→4ℓ
      ...
      reson: [{ key: &quot;H&quot;, m: 124, hw: 5, sg: 2.8, thr: 5.5, amp: 0.66, label: &quot;H 125&quot;, pp: true }],
      primary: &quot;H&quot;,
      title: &quot;CMS \xB7 H\u2192ZZ*\u21924\u2113 \xB7 Goldkanal (Higgs bei 125 GeV)&quot;,
      sub: &quot;Kleines Signal auf gro\xDFem ZZ*-Untergrund \xB7 braucht Protonen + volle Energie&quot;,
      disco: &quot;\u{1F31F} 5\u03C3: Higgs-Boson entdeckt!&quot;
    },
    ALICE: {
      // Schwerionen-Programm: Quarkonia (QGP)
      pool: () => CERN_REAL.ion,
      range: [1, 12],
      bins: 55,
      channel: &quot;2mu&quot;,
      ...
      reson: [
        { key: &quot;Jpsi&quot;, m: 3.097, hw: 0.5, sg: 0.18, thr: 0.4, amp: 0.73, label: &quot;J/\u03C8&quot;, qgp: true },
        { key: &quot;Ups&quot;, m: 9.6, hw: 0.9, sg: 0.7, thr: 0.6, amp: 0.16, label: &quot;\u03A5&quot;, qgp: true }
      ],
      primary: &quot;Jpsi&quot;,
    ...
    LHCB: {
      // pp-Programm: B-Physik / CP-Verletzung
      pool: () => lhcbPool(),
      range: [4.6, 6],
      bins: 50,
      channel: &quot;B&quot;,
  ...
  var beamLabel = (b) => b === &quot;PbPb&quot; ? &quot;Blei-Ionen&quot; : &quot;Protonen&quot;;
  var curBeam = () => s3.isIon ? &quot;PbPb&quot; : &quot;pp&quot;;
  function discoBeamOK(sp) {
    return sp.discoBeam === &quot;any&quot; || sp.discoBeam === curBeam();
  }
  function wrongBeamShort(sp) {
    return sp.discoBeam === &quot;PbPb&quot; ? &quot;p-p-Referenz \xB7 QGP nur in Pb-Pb&quot; : &quot;Falsches Strahl-Programm \xB7 braucht &quot; + beamLabel(sp.discoBeam);
  }
  ...
  function prodVis(r) {
    return energyVis(r.thr) * (r.pp &amp;&amp; s3.isIon ? 0 : 1);
  }
  function drawVis(r) {
    return prodVis(r) * (r.qgp &amp;&amp; s3.isIon ? 0.45 : 1);
  }
  ...
  function resoName(key) {
    return key === &quot;Jpsi&quot; ? &quot;J/psi&quot; : key === &quot;Ups&quot; ? &quot;Upsilon(1S)&quot; : key;
  }
  function classify(m) {
  ...
  function generateMassData() {
    ...
    for (let i = 0; i < n; i++) store.push(sampleMass(sp));
  ...
  function getSignificance() {
    ...
    if (pv <= 0) return 0;
    return 5 * Math.sqrt(n / sp.target) * pv;
  }
  function drawHist() {
    const sp = spec();
    ...
    const wrongBeam = !discoBeamOK(sp);
    const notProd = !wrongBeam &amp;&amp; prodVis(prim) <= 0;
    $(&quot;lbl-sig&quot;).innerText = sig.toFixed(2) + &quot; \u03C3&quot;;
    let sigBar = $(&quot;sig-bar&quot;), sigStatus = $(&quot;lbl-sig-status&quot;);
    sigBar.style.width = (wrongBeam || notProd ? 0 : Math.min(100, sig / 5 * 100)) + &quot;%&quot;;
    if (sig === 0) {
      sigStatus.innerText = wrongBeam ? wrongBeamShort(sp) : notProd ? &quot;Inbetriebnahme \xB7 &quot; + prim.label + &quot;-Rate zu gering&quot; : &quot;Rauschen (Kein Signal)&quot;;
    ...
    if (sig < 5) {
      ...
      if (wrongBeam) {
        ctxHist.fillText(sp.discoBeam === &quot;PbPb&quot; ? &quot;\u2139\uFE0F p-p-Referenz: Quarkonia unverdr\xE4ngt. QGP-Unterdr\xFCckung nur im Pb-Pb-Lauf sichtbar.&quot; : &quot;\u26A0\uFE0F &quot; + prim.label + &quot;-Entdeckung braucht &quot; + beamLabel(sp.discoBeam) + &quot;-Strahl \u2014 aktuell &quot; + beamLabel(curBeam()) + &quot;. Falsches Preset.&quot;, 36, h - 26);
      } else if (notProd) {
        ctxHist.fillText(&quot;\u26A0\uFE0F &quot; + prim.label + &quot;-Produktionsrate bei &quot; + s3.paramEnergy.toFixed(2) + &quot; TeV zu gering f\xFCr Entdeckung \u2014 \u2265 &quot; + prim.thr.toFixed(2) + &quot; TeV n\xF6tig.&quot;, 36, h - 26);
      } else if (s3.collStore[s3.selDet] === 0) {
        ctxHist.fillText(&quot;Keine Kollisionen in &quot; + s3.selDet + &quot;. Starte Kollisionen!&quot;, 36, h - 26);
      } else if (sp.reson.some((r) => r.qgp) &amp;&amp; s3.isIon) {
        ctxHist.fillText(&quot;Sammle Statistik \xB7 QGP unterdr\xFCckt &quot; + prim.label + &quot; (Signifikanz: &quot; + sig.toFixed(1) + &quot;\u03C3 / 5.0\u03C3)&quot;, 36, h - 26);
      } else {
  ...
  var PARAM_INFO = {
    ...
    prePp: 'Der Standard-Physiklauf des LHC: Protonen gegen Protonen bei voller Energie (Run 3: 6,8 TeV/Strahl \u2192 13,6 TeV). Auf DIESEM einen Strahl laufen in Wirklichkeit alle Experimente gleichzeitig: ATLAS &amp; CMS suchen das Higgs-Boson (2012 bei 8 TeV entdeckt, Nobelpreis 2013) im \u201EGoldkanal&quot; H\u2192ZZ*\u21924\u2113 und vermessen das Z\u2070 als Kalibrierung; LHCb untersucht parallel die CP-Verletzung an B-Mesonen (warum es mehr Materie als Antimaterie gibt). Higgs und CP-Verletzung brauchen also dieselbe Maschinen-Einstellung \u2013 wechsle einfach den Detektor-Tab. So f\xE4hrt der LHC ~90 % der Zeit.',
    preQgp: 'Der Schwerionen-Lauf (~1 Monat pro Jahr, meist am Jahresende): Statt Protonen kollidieren ganze Blei-Kerne bei 2,68 TeV/Nukleon (\u221As_NN = 5,36 TeV in Run 3). In der Mini-Explosion entsteht f\xFCr 10\u207B\xB2\xB3 s das Quark-Gluon-Plasma: ein \u201EUr-Zustand&quot; der Materie bei \xFCber 10\xB9\xB2 \xB0C, in dem Quarks und Gluonen frei sind \u2013 wie wenige Millionstelsekunden nach dem Urknall. ALICE ist der Spezialdetektor daf\xFCr und l\xF6st die tausenden Teilchen einer einzigen Kollision auf. ATLAS/CMS messen hier das Z\u2070 als \u201EStandardkerze&quot; (es koppelt nicht ans Plasma).',
    prePilot: 'Kein Physik-Experiment, sondern die Inbetriebnahme. Der Strahl l\xE4uft nur mit Injektionsenergie (0,45 TeV, kein Hochfahren) und wenigen Protonen. Bei so geringer Rate entsteht praktisch nichts Neues \u2013 das ist Absicht: Mit einem \u201Eleichten&quot; Strahl pr\xFCfen die Operateure gefahrlos die Strahlf\xFChrung, Optik und Steuerung. Erst wenn alles stabil l\xE4uft, wird auf volle Energie und Intensit\xE4t hochgefahren. So beginnt real jeder LHC-Betriebszyklus.'
  };
  ...
  function wireHandlers() {
    ...
    E5.btnPrePp.addEventListener(&quot;click&quot;, () => {
      ...
      s4.activePhysicsMode = &quot;PP&quot;;
      App.updateReadouts();
      selectDetector(&quot;CMS&quot;);
      App.setStatus(&quot;PRESET GELADEN: Protonen-Physik (Run 3 \xB7 13.6 TeV) \u2014 Higgs (CMS), Z\u2070 (ATLAS) &amp; CP-Verletzung (LHCb) laufen alle auf diesem Strahl. Detektor-Tab wechseln!&quot;, &quot;on&quot;);
    });
    E5.btnPreQgp.addEventListener(&quot;click&quot;, () => {
      ...
      App.setStatus(&quot;PRESET GELADEN: Schwerionen-Lauf (Pb-Pb \xB7 2.68 TeV/u, \u221As_NN = 5.36 TeV) \u2192 Quark-Gluon-Plasma in ALICE. ATLAS misst Z\u2070 als Standardkerze.&quot;, &quot;on&quot;);
    });
