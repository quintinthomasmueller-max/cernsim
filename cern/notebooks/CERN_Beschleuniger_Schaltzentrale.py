...
<script>(() => {
  ...
  function drawGeo() {
    ...
    if (GEO.ti) [&quot;ti2&quot;, &quot;ti8&quot;].forEach((k) => {
      ...
      if (!d) return;
      const pr = d.split(&quot; &quot;);
      const ctrl = (pr[3] || &quot;&quot;).split(&quot;,&quot;).map(Number);
      if (ctrl.length === 2) g2.appendChild(label(ctrl[0], ctrl[1], k.toUpperCase().replace(&quot;TI&quot;, &quot;TI &quot;), {
        fill: &quot;rgba(46,164,79,0.85)&quot;,
        &quot;font-size&quot;: &quot;7px&quot;,
        &quot;font-family&quot;: &quot;monospace&quot;,
        &quot;text-anchor&quot;: &quot;middle&quot;
      }));
    ...
    g2.appendChild(label(6, 474, &quot;\xA9 OpenStreetMap-Mitwirkende (ODbL) \xB7 Web-Mercator \xB7 TI 2/8 approx.&quot;, {
